...
export const INST_TAXA_EMPRESARIAL_OUTPUT = '{{instTextoProtocolo}}\n\n{{instTextoOS}}'
...
export function buildInstTaxaEmpresarialTextos(
...
export function getInstTaxaEmpresarialDefaults(): OsTemplatePresetPayload {
  return {
    slug: 'inst-taxa-empresarial',
    title: 'Instalação com taxa — Empresarial (PJ)',
    demandCategory: 'instalacao-taxa',
    outputTemplate: INST_TAXA_EMPRESARIAL_OUTPUT,
    fields: INST_TAXA_EMPRESARIAL_FIELDS.map((f) => ({ ...f })),
    operatorGuidance: {
