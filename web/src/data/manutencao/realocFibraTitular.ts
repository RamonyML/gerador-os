...
=== Texto O.S ===
{{clientePrimeiro}} ENTROU EM CONTATO POR {{canal}} ({{contatoNumerico}}) PARA SOLICITAR SUPORTE. QUESTIONADO, DISSE "{{motivoUpper}}". {{valor}} CLIENTE PAGARÁ EM {{formaPag}}. AGENDADA PARA {{dataVisita}} ÀS {{horaVisita}} HORAS.
...
const FIELDS: OsTemplateField[] = [
  ...
  {
    id: 'motivo',
    label: 'Motivo do remanejamento (trecho após “disse que”)',
    control: 'text',
    section: S_SOL,
    layout: { md: 9 },
  },
...
export function getManutRealocFibraTitularDefaults(): OsTemplatePresetPayload {
  return {
    slug: 'manut-realoc-fibra-titular',
    title: 'Remanejamento de fibra — titular presente',
