    ...
    items: [
      {
        ...
        to: '/gerar-os?demanda=midia-tv&slug=midia-roku-padrao',
      ...
      },
      {
        ...
        to: '/gerar-os?demanda=midia-tv&slug=midia-roku-presencial',
...
export function MidiaTvHubPage() {
  return (
    <HubCatalog
      ...
      subtitle={
        <Typography variant="body1" color="text.secondary">
          Selecione o tipo de conversor de mídia para gerar a O.S correspondente.
        </Typography>
      }
      illustration="tv"
      illustrationAlt="Conversores de mídia e TV"
      toolbarLabel="Tipos de conversor"
      backTo="/suporte"
